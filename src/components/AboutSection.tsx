...
export const AboutSection = () => {
  ...
  return (
    <section id="sobre" className="flex w-full min-h-screen items-center justify-center gap-x-20 max1070:flex-col-reverse max620:h-auto" data-aos="zoom-in-up">
      <div className="mt-20 max620:mt-0 max1070:mt-0">
        <Image
      ...
      <div className="flex flex-col items-center justify-center w-[600px] text-center gap-y-5 mt-14 max620:mt-0 max675:w-[550px] max620:w-[500px] max550:w-[450px] max480:w-[400px] max425:w-[350px] max425:gap-y-2 max375:w-[300px]">
        ...
        <p className="text-[1.1rem] text-slate-50 tracking-wide max700:text-[1rem] max700:tracking-[0px] max425:text-[15px] max400:text-[14px]">
          Meu nome é Douglas Lincoln, tenho 25 anos e sou um desenvolvedor Full-Stack especializado em criar soluções digitais de alta qualidade. Minha experiência inclui uma ampla gama de tecnologias para desenvolvimento web e mobile.
        </p>
        ...
        <SocialMediaLinkAlt href="assets/certificados/Currículo Douglas_dev.pdf" icon={FaFileAlt}>
